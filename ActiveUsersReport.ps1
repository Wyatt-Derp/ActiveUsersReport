...
$blacklist = "svc|Mailbox|srvc|admin|billing|support|lab|ctac|scan|sharepoint|windows|window|n-able|nable|cluster|test|local|ACE|AAD|ncentral|MSOL|Open DNS|opendns|OneLogin|Airwatch|Temp|service|mastercontrol|copier|scan|fax|room"
